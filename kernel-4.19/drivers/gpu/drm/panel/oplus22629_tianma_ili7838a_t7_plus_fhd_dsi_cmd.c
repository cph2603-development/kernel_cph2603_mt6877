...
#include "../mediatek/mtk_corner_pattern/oplus22629_chengdu_data_hw_roundedpattern.h"
...
static bool reboot_backlight_level = false;
...
//	char bl_tb2[] = {0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00};
	...
	if (level > 4095)
		level = 4095;
	if (reboot_backlight_level == true && level == 4095) {
		level = 2047;
		reboot_backlight_level = false;
	}
