...
#include "atom_imx355mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = ATOM_IMX355_SENSOR_ID,
	.checksum_value = 0xf17e8986,

	.pre = {
		.pclk = 201600000,// 288000000,
		.linelength = 1836,//3672,
		.framelength = 3660,//2612,
		.startx = 0,
		.starty = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
	{3280, 2464,   8,   8,   3264, 2448, 1632, 1224,   0,   0, 1632, 1224, 0, 0, 1632, 1224},//pre
	{3280, 2464,   8,   8,   3264, 2448, 3264, 2448,   0,   0, 3264, 2448, 0, 0, 3264, 2448},//cap
	{3280, 2464,   8, 312,   3264, 1840, 3264, 1840,   0,   0, 3264, 1840, 0, 0, 3264, 1840},//video
...
static kal_uint32 set_test_pattern_mode(kal_uint8 modes, struct SET_SENSOR_PATTERN_SOLID_COLOR *pdata)
{
