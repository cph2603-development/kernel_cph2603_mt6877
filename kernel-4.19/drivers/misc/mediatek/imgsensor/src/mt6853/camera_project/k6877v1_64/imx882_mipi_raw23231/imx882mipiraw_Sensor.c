...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX882_SENSOR_ID23231,
...
static struct SENSOR_VC_INFO2_STRUCT SENSOR_VC_INFO2[] = {
    ...
    },
    {
        ...
        {
            {VC_STAGGER_NE, 0x00, 0x2b, 0x1000, 0xc00},
            {VC_PDAF_STATS_NE_PIX_1, 0x03, 0x30, 0x1400, 0x300},
#if PD_PIX_2_EN
            {VC_PDAF_STATS_NE_PIX_2, 0x06, 0x2b, 0x800, 0x300},
#endif
        },
    ...
    },
    {
        ...
        {
            {VC_STAGGER_NE, 0x00, 0x2b, 0x1000, 0x900},
            {VC_PDAF_STATS_NE_PIX_1, 0x03, 0x30, 0x1400, 0x240},
#if PD_PIX_2_EN
            {VC_PDAF_STATS_NE_PIX_2, 0x06, 0x2b, 0x800, 0x240},
#endif
        },
            ...
            *sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
            ...
            if (*sensor_id == IMX882_SENSOR_ID || *sensor_id == IMX882_SENSOR_ID2) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                read_sensor_verison();
                if(first_read){
                    read_imx882_23231_SPC(imx882_SPC_setting);
                    read_imx882_23231_QSC(imx882_QSC_setting);
                    first_read = KAL_FALSE;
                }
                if(deviceInfo_register_value == 0x00){
                    Eeprom_DataInit(0, IMX882_SENSOR_ID23231);
...
static void feedback_awbgain(kal_uint32 r_gain, kal_uint32 b_gain)
{
    ...
    imx882_feedback_awbgain[1] = r_gain_int;
    imx882_feedback_awbgain[3] = (
        ((r_gain*100) / 512) - (r_gain_int * 100)) * 2;
    imx882_feedback_awbgain[5] = b_gain_int;
    imx882_feedback_awbgain[7] = (
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx882_table_write_cmos_sensor(imx882_23231_seamless_preview, sizeof(imx882_23231_seamless_preview) / sizeof(kal_uint16));
        if (ae_ctrl) {
    ...
    case MSDK_SCENARIO_ID_CUSTOM5:
    {
        ...
        FMC_GPH_START;
        imx882_table_write_cmos_sensor(imx882_23231_seamless_custom5, sizeof(imx882_23231_seamless_custom5) / sizeof(kal_uint16));
        if (ae_ctrl) {
