 ...
 *
 ****************************************************************************/
#ifndef _IMX882MIPI_SENSOR_H
#define _IMX882MIPI_SENSOR_H
...
struct imgsensor_info_struct {
    ...
    kal_uint8 custom10_delay_frame; /* enter custom10 elay frame num */
...
#define chip_revision_reg 0x0018
typedef enum chip_revison {
    HW_CUT0_90 = 0,
    HW_CUT0_91,
    HW_CUT1_0,
    HW_MP,
