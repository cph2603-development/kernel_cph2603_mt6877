...
#include "imx882_seamless_switch.h"
...
#define PFX "imx882_camera_sensor"
#define LOG_1 LOG_INF("IMX882,MIPI 4LANE\n")
/****************************Modify end**************************/
...
static kal_uint16 imx882_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len);
static kal_uint16 imx882_burst_write_cmos_sensor(kal_uint16 *para, kal_uint32 len);
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static kal_uint16 imx882_SPC_setting[SPC_SIZE*2];
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX882_SENSOR_ID23687,
...
static kal_uint16 imx882_table_write_cmos_sensor(kal_uint16 *para,
                         kal_uint32 len)
{
...
static kal_uint16 imx882_burst_write_cmos_sensor(
...
static kal_uint16 imx882_init_setting[] = 
{
...
static kal_uint16 imx882_preview_setting[] = {
//3Lane
//reg_A
...
static kal_uint16 imx882_capture_setting[] = {
//3Lane
//reg_A
//QBIN(VBIN)_4096x3072_30FPS with PDAF VB_max
//H: 4096
...
static kal_uint16 imx882_normal_video_setting[] = {
//3Lane
//reg_B
...
static kal_uint16 imx882_hs_video_setting[] = {
//3Lane
//reg_C-4
...
static kal_uint16 imx882_slim_video_setting[] = {
//3Lane
//reg_A
//QBIN(VBIN)_4096x3072_30FPS with PDAF VB_max
//H: 4096
...
static kal_uint16 imx882_custom1_setting[] = {
//3Lane
//reg_B4
...
static kal_uint16 imx882_custom2_setting[] = {
//3Lane
//reg_B-1
...
static kal_uint16 imx882_custom3_setting[] = {
//3Lane
//reg_D
...
static kal_uint16 imx882_custom4_setting[] = {
    //3Lane
    //reg_C-5
...
static kal_uint16 imx882_custom5_setting[] = {
//3Lane
//reg_A-3-S1
...
static kal_uint16 imx882_custom6_setting[] = {
//3Lane
//reg_C-6
...
static kal_uint16 imx882_custom7_setting[] = {
    //3Lane
    //reg_A
    //QBIN(VBIN)_4096x3072_30FPS with PDAF VB_max
    //H: 4096
...
static kal_uint16 imx882_custom8_setting[] = {
    //3Lane
    //reg_B
    //QBIN(VBIN)_4096x2304 @30FPS with PDAF VB_max
    //H: 4096
...
static kal_uint16 imx882_custom9_setting[] = {
//3Lane
//reg_C-3
...
static kal_uint16 imx882_custom10_setting[] = {
//3Lane
//reg_B
//QBIN(VBIN)_4096x2304 @30FPS with PDAF VB_max
//H: 4096
...
static void sensor_init(void)
{
    ...
    imx882_table_write_cmos_sensor(imx882_init_setting,
        sizeof(imx882_init_setting)/sizeof(kal_uint16));
...
{
    LOG_INF("%s start\n", __func__);
    imx882_table_write_cmos_sensor(imx882_preview_setting,
...
{
    LOG_INF("%s start\n", __func__);
    imx882_table_write_cmos_sensor(imx882_capture_setting,
...
{
    LOG_INF("%s start\n", __func__);
    imx882_table_write_cmos_sensor(imx882_normal_video_setting,
...
{
    LOG_INF("%s start\n", __func__);
    imx882_table_write_cmos_sensor(imx882_hs_video_setting,
...
{
    LOG_INF("%s start\n", __func__);
    imx882_table_write_cmos_sensor(imx882_slim_video_setting,
...
static void custom1_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx882_table_write_cmos_sensor(imx882_custom1_setting,
...
static void custom2_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx882_table_write_cmos_sensor(imx882_custom2_setting,
...
static void custom3_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx882_table_write_cmos_sensor(imx882_custom3_setting,
...
static void custom4_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx882_table_write_cmos_sensor(imx882_custom4_setting,
...
static void custom5_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx882_table_write_cmos_sensor(imx882_custom5_setting,
...
static void custom6_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx882_table_write_cmos_sensor(imx882_custom6_setting,
...
static void custom7_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx882_table_write_cmos_sensor(imx882_custom7_setting,
...
static void custom8_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx882_table_write_cmos_sensor(imx882_custom8_setting,
...
static void custom9_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx882_table_write_cmos_sensor(imx882_custom9_setting,
...
static void custom10_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx882_table_write_cmos_sensor(imx882_custom10_setting,
...
{
    kal_uint8 qsc_is_valid = Eeprom_1ByteDataRead(OTP_QSC_OFFSET + QSC_SIZE, IMX882_EEPROM_SLAVE_ADDRESS);
    LOG_INF("%s start write_sensor_QSC, qsc_is_valid:%d, qsc_flag:%d\n", __func__, qsc_is_valid, qsc_flag);
    if (qsc_is_valid == 1 && !qsc_flag) {
        imx882_burst_write_cmos_sensor(imx882_QSC_setting,
...
{
    kal_uint8 spc_is_valid = Eeprom_1ByteDataRead(OTP_SPC_OFFSET + SPC_SIZE, IMX882_EEPROM_SLAVE_ADDRESS);
    LOG_INF("%s start write_sensor_spc, spc_is_valid:%d, spc_flag:%d", __func__, spc_is_valid, spc_flag);
    if (spc_is_valid == 1 && !spc_flag) {
        imx882_table_write_cmos_sensor(imx882_SPC_setting,
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
            ...
            if (*sensor_id == IMX882_SENSOR_ID23687) {
                *sensor_id = imgsensor_info.sensor_id;
                LOG_INF("Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                if(first_read){
                    read_imx882_23687_SPC(imx882_SPC_setting);
                    read_imx882_23687_QSC(imx882_QSC_setting);
                    first_read = KAL_FALSE;
                }
                if(deviceInfo_register_value == 0x00){
                    Eeprom_DataInit(0, IMX882_SENSOR_ID23687);
...
static kal_uint16 imx882_feedback_awbgain[] = {
    0x0104, 0x01,
    0x0B8E, 0x01,
    0x0B8F, 0x00,
    0x0B90, 0x02,
...
static void feedback_awbgain(kal_uint32 r_gain, kal_uint32 b_gain)
{
    ...
    r_gain_int = r_gain * 256 / 512;
    b_gain_int = b_gain * 256 / 512;

    imx882_feedback_awbgain[7] = r_gain_int >> 8;
    imx882_feedback_awbgain[9] = r_gain_int & 0xFF;
    imx882_feedback_awbgain[11] = b_gain_int >> 8;
    imx882_feedback_awbgain[13] = b_gain_int & 0xFF;

    imx882_table_write_cmos_sensor(imx882_feedback_awbgain,
        sizeof(imx882_feedback_awbgain)/sizeof(kal_uint16));
}
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx882_table_write_cmos_sensor(imx882_23687_seamless_preview, sizeof(imx882_23687_seamless_preview) / sizeof(kal_uint16));
        if (ae_ctrl) {
    ...
    case MSDK_SCENARIO_ID_CUSTOM5:
    {
        ...
        FMC_GPH_START;
        imx882_table_write_cmos_sensor(imx882_23687_seamless_custom5, sizeof(imx882_23687_seamless_custom5) / sizeof(kal_uint16));
        if (ae_ctrl) {
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MINT32 *)(signed long)(*(feature_data + 1)) = 2534000;
        LOG_INF("exporsure");
        break;
