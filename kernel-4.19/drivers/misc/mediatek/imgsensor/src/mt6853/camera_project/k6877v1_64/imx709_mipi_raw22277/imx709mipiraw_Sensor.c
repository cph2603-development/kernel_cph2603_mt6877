...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX709_SENSOR_ID22277,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
    ...
    {6560, 4928, 0,  16, 6560, 4896, 6528, 4896,  1632,   1224, 3264, 2448,  0,  0, 3264, 2448}, /* custom5 reg_N3 izoom*/
            ...
            *sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
            ...
            if (*sensor_id == IMX709_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if(first_read){
                    read_imx709_22277_LRC(imx709_LRC_setting);
                    read_imx709_22277_QSC(imx709_QSC_setting);
                    first_read = KAL_FALSE;
                }
                if(deviceInfo_register_value == 0x00){
                    Eeprom_DataInit(3, IMX709_SENSOR_ID22277);
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx709_table_write_cmos_sensor(imx709_22277_seamless_preview, sizeof(imx709_22277_seamless_preview) / sizeof(kal_uint16));
        if (ae_ctrl) {
    ...
    case MSDK_SCENARIO_ID_CUSTOM1:
    {
        ...
        FMC_GPH_START;
        imx709_table_write_cmos_sensor(imx709_22277_seamless_custom1, sizeof(imx709_22277_seamless_custom1) / sizeof(kal_uint16));
        if (ae_ctrl) {
